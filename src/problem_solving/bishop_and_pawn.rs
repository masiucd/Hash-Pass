...
mod tests {
    ...
    fn a1_and_c3_bishop_will_catch() {
        assert_eq!(super::solution("a1".to_string(), "c3".to_string()), true);
    }
    #[test]
    fn a1_and_a3_bishop_will_miss() {
        assert_eq!(super::solution("a1".to_string(), "a3".to_string()), false);
    }
    #[test]
    fn g1_and_f3_bishop_will_miss() {
        assert_eq!(super::solution("g1".to_string(), "f3".to_string()), false);
    }
    #[test]
    fn e3_and_a7_bishop_will_catch() {
        assert_eq!(super::solution("e3".to_string(), "a7".to_string()), true);
    }
}
